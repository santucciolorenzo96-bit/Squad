...
export function Squadra() {
  ...
  return (
    <div className="sezioni">
      ...
      <NuoveSocieta avvisa={avvisa} />
    </div>
  );
}

/* ========================================================= nuove societa' */
/* Il pannello dei codici di attivazione.
 *
 * Compare solo a chi amministra la PIATTAFORMA, che non e' lo stesso di chi
 * amministra una societa': admin qui dentro vuol dire "comando questo club",
 * e se bastasse quello ogni club potrebbe fabbricare societa' a piacere.
 *
 * Il controllo vero e' nel database (migrazione 027): qui si decide solo se
 * disegnare il pannello. Nascondere un pulsante non impedisce a nessuno di
 * chiamare la funzione — e infatti la funzione, se non sei nell'elenco, dice
 * di no da sola.
 */
function NuoveSocieta({ avvisa }) {
