...
export const NAV_ICONS = {
  ...
  comunicazioni: '<path d="M3.4 5.4a2 2 0 0 1 2-2h9.2a2 2 0 0 1 2 2v6.6a2 2 0 0 1-2 2H8.6L5 17v-3H5.4a2 2 0 0 1-2-2z" stroke-linejoin="round"/><circle cx="7.4" cy="8.7" r="1.1" fill="currentColor" stroke="none"/><circle cx="10.8" cy="8.7" r="1.1" fill="currentColor" stroke="none"/><circle cx="14.2" cy="8.7" r="1.1" fill="currentColor" stroke="none"/>',
  situazione: '<path d="M2.6 10.6h3.1l1.7-4.4 2.8 8.2 2-5.1 1.3 1.3h3.9"/><circle cx="16.4" cy="10.6" r="1.6" fill="currentColor" stroke="none"/><circle cx="2.6" cy="10.6" r="1.2" fill="currentColor" stroke="none"/>',
  documenti: '<path d="M6 2.6h5.4l3.6 3.6V17a1.2 1.2 0 0 1-1.2 1.2H6A1.2 1.2 0 0 1 4.8 17V3.8A1.2 1.2 0 0 1 6 2.6z"/><path d="M11.4 2.6v3.6H15"/><path d="M7.4 11h5M7.4 14h3.4"/>',
